...
<table>
    ...
    <tr><td colspan="3">2 - يلتزم الطرف الأول بدفع مبلغ وقدره {{ $project->design_fee ?? 0 }} درهم غير شامل الضريبة، للطرف الثاني مقابل أعمال التصاميم.</td></tr>
    ...
    <tr><td colspan="3">9 - يلتزم الطرف الثاني بزيارات إشرافية بمعدل أربع (4) شهريًا، قابلة للزيادة أو النقصان حسب احتياجات المشروع، ولا تُستحق رسوم الإشراف عند توقف العمل بالموقع شهرا او اكثر ما لم توجد أعمال مكتبية أو تنسيقية تُعد بديلاً عن الإشراف.</td></tr>
