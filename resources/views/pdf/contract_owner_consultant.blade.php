...
<table>
    ...
    <tr>
    <td colspan="3">
        14 - يحق للطرف الأول تغيير الاستشاري أثناء التنفيذ فقط، وفي حال الإنهاء قبل التنفيذ يلتزم بدفع المستحقات الخاصة بأعمال التصميم، والمبلغ المدفوع في البند رقم 2 هو نظير المخططات المبدئية فقط.
    </td>
</tr>
</table>
